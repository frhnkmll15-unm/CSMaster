...
public interface CategoryRepo extends JpaRepository<Category, Long>{
    ...
    Page<Category> findByIsDeleteAndCategoryName(Pageable page , byte byteIsDelete,String values);

    Page<Category> findByIsDeleteAndId(Pageable page , byte byteIsDelete, Long values);
